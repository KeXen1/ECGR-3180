...
int main(){
    ...
    numvec = {8, 4, 2, 1};
    n = countInv(numvec);
    std::cout << "Number of inversions " << n << std::endl; // Should be 6
    
    numvec = {3, 1, 2, 4, 5};
    n = countInv(numvec);
    std::cout << "Number of inversions " << n << std::endl; // Should be 2
    
    numvec = {1, 3, 5, 2, 4, 6};
    n = countInv(numvec);
    std::cout << "Number of inversions " << n << std::endl; // Should be 3
